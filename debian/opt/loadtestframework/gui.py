...
THEME_COLORS = {
    ...
    "red_hover": "#e63232",
    "red_dark": "#8b0f0f",
    "red_glow": "rgba(196, 30, 30, 0.35)",
    "red_subtle": "rgba(196, 30, 30, 0.08)",
    "text_primary": "#d8d8dc",
    ...
    "warning": "#d47800",
    "error": "#d63031",
    "error_glow": "rgba(214, 48, 49, 0.25)",
    "input_bg": "#060608",
    "input_border": "#18181e",
    "input_focus": "#c41e1e",
    "table_header": "#060608",
...
class TestRunnerTab(QWidget):
    ...
    def _read_output(self):
        ...
        # Filter out docker service create noise, keep only orchestrate.py output
        filtered_lines = []
        for line in data.splitlines(keepends=True):
            if not self._is_docker_noise(line):
